...
def test_manager_config_rejects_removed_adaptive_step_balance_fields() -> None:
...
def test_manager_config_rejects_removed_track_sampling_mode_names(old_mode: str) -> None:

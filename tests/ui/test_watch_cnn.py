...
from rl_fzerox.ui.watch.runtime.cnn import CnnActivationSampler, _activation_grid
...
def test_cnn_activation_sampler_throttles_policy_captures() -> None:
    ...
    first = sampler.capture(enabled=True, policy_runner=policy_runner, observation={})
    second = sampler.capture(enabled=True, policy_runner=policy_runner, observation={})

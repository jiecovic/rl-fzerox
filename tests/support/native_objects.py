...
def make_telemetry(
    *,
    ...
    menu_selected_mode_raw: int = 0,
    menu_difficulty_state_raw: int = 0,
    menu_difficulty_cursor_raw: int = 0,
    menu_transition_state_raw: int = 0,
    menu_current_ghost_type_raw: int = 0,
    queued_game_mode_raw: int = 0,
    ...
    return FZeroXTelemetry(
        {
            ...
            "menu_selected_mode_raw": menu_selected_mode_raw,
            "menu_difficulty_state_raw": menu_difficulty_state_raw,
            "menu_difficulty_cursor_raw": menu_difficulty_cursor_raw,
            "menu_transition_state_raw": menu_transition_state_raw,
            "menu_current_ghost_type_raw": menu_current_ghost_type_raw,
            "queued_game_mode_raw": queued_game_mode_raw,
        }
    )

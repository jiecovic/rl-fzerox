...
use libretro_sys::{
    ...
    DEVICE_ID_JOYPAD_DOWN, DEVICE_ID_JOYPAD_L2, DEVICE_ID_JOYPAD_LEFT, DEVICE_ID_JOYPAD_R2,
    DEVICE_ID_JOYPAD_RIGHT, DEVICE_ID_JOYPAD_START, DEVICE_ID_JOYPAD_UP, DEVICE_ID_JOYPAD_Y,
    DEVICE_INDEX_ANALOG_LEFT, DEVICE_INDEX_ANALOG_RIGHT,
};

...
pub(crate) struct GlobalOffsets {
    ...
    pub difficulty_menu_state: usize,
    pub difficulty_menu_cursor: usize,
...
pub(crate) const GLOBALS: GlobalOffsets = GlobalOffsets {
    ...
    difficulty_menu_state: rdram_offset(0x800C_D384),
    difficulty_menu_cursor: rdram_offset(0x800C_D388),

// web/run-manager/src/test/widgets/configurator/ConfiguratorTracks.test.tsx
...
describe("Configurator", () => {
  ...
  it("supports pooled vehicle selection and random engine ranges in the vehicle tab", async () => {
    ...
    expect(screen.getByRole("slider", { name: "Engine range minimum" })).toHaveAttribute(
      "aria-valuetext",
      "20.3%",
    );
    expect(screen.getByRole("slider", { name: "Engine range maximum" })).toHaveAttribute(
      "aria-valuetext",
      "79.7%",
    );
  });

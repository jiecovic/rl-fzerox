// src/rl_fzerox/apps/run_manager/web/src/features/runs/chartsPanel/RunChartLegend.tsx

import { chartSeriesColor, type LineageRunGroup } from "@/features/runs/chartsPanel/model";

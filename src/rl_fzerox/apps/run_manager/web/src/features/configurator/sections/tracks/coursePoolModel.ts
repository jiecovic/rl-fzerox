// src/rl_fzerox/apps/run_manager/web/src/features/configurator/sections/tracks/coursePoolModel.ts
import type { BuiltInCourse, TrackCupView } from "@/features/configurator/sections/tracks/types";

// src/rl_fzerox/apps/run_manager/web/src/entities/runConfig/ui/sections/tracks/options.ts
import type { TracksConfig } from "@/entities/runConfig/ui/sections/tracks/types";

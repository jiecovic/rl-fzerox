// src/rl_fzerox/apps/run_manager/web/src/entities/runConfig/ui/sections/tracks/coursePoolModel.ts

import type { BuiltInCourse, TrackCupView } from "@/entities/runConfig/ui/sections/tracks/types";

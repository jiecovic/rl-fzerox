// src/rl_fzerox/apps/run_manager/web/src/entities/runConfig/ui/sections/observation/featureRows.ts

import { stateFeatureInfo } from "@/entities/runConfig/ui/sections/stateFeatureInfo";

// src/rl_fzerox/apps/run_manager/web/src/entities/runConfig/ui/sections/tracks/TrackMinimap.tsx

import {
  COURSE_MINIMAP_PATHS,
  COURSE_MINIMAP_VIEW_BOX,
} from "@/entities/runConfig/ui/sections/tracks/courseMinimapData";

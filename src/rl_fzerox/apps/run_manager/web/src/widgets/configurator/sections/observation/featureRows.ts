// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/observation/featureRows.ts

import type { ConfigMetadata, ManagedRunConfig, StateComponentConfig } from "@/shared/api/contract";
import { stateFeatureInfo } from "@/widgets/configurator/sections/stateFeatureInfo";

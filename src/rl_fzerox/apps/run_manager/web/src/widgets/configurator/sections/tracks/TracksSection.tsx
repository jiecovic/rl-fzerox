// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/tracks/TracksSection.tsx
import { useMemo } from "react";

import { ConfigStack } from "@/widgets/configurator/ConfigLayout";
import { usePersistentCollapsedIds } from "@/widgets/configurator/disclosureState";
import { CoursePoolPanel } from "@/widgets/configurator/sections/tracks/CoursePoolPanel";
import {
  allBuiltInCourseIds,
  buildTrackCupViews,
  defaultSelectedCourseIds,
  orderedCourseIds,
} from "@/widgets/configurator/sections/tracks/coursePoolModel";
import { X_CUP } from "@/widgets/configurator/sections/tracks/options";
import {
  CourseSamplingPanel,
  RaceSetupPanels,
} from "@/widgets/configurator/sections/tracks/RaceSamplingPanels";
import type {
  GpDifficulty,
  TracksConfig,
  TracksSectionProps,

// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/action/branches/model.ts
import type { AuxiliaryActionConfig } from "@/widgets/configurator/sections/action/branches/types";

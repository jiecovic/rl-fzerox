// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/tracks/options.ts
import type { TracksConfig } from "@/widgets/configurator/sections/tracks/types";

// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/observation/stateComponents/ComponentSettings.tsx

import type { StateComponentConfig } from "@/shared/api/contract";
import { IntegerField } from "@/widgets/configurator/fields";

// src/rl_fzerox/apps/run_manager/web/src/widgets/configurator/sections/policy/layerEditors/CustomConvTableRows.tsx
...
import { IntegerTextInput } from "@/widgets/configurator/fields/basicNumbers";
import {
  formatConvSpatial,
  formatFitMode,
  ...
  formatParamCount,
  formatPixelDrop,
} from "@/widgets/configurator/sections/policy/convPreviewFormatting";
import {
...
} from "@/widgets/configurator/sections/policy/layerEditors/customCnnLayers";
import { syncLayerRowIds } from "@/widgets/configurator/sections/policy/layerEditors/layerRows";
import type {
  CustomCnnActivation,
  CustomCnnLayerKind,
  CustomCnnNumericKey,
} from "@/widgets/configurator/sections/policy/layerEditors/types";
import {
  customCnnRowClass,
  useCustomCnnLayerDrag,
} from "@/widgets/configurator/sections/policy/layerEditors/useCustomCnnLayerDrag";

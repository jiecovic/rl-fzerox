...
def _draw_observation_glass_box(
    *,
    ...
    pygame.draw.rect(screen, _GLASS_VIEW_STYLE.shadow, rect.move(0, 3), border_radius=13)
    pygame.draw.rect(screen, (7, 10, 12), rect, border_radius=13)
    pygame.draw.rect(screen, _GLASS_VIEW_STYLE.frame_highlight, rect, width=1, border_radius=13)
    pygame.draw.rect(
        screen,
        _GLASS_VIEW_STYLE.frame_edge,
        rect.inflate(-4, -4),
        width=1,
        border_radius=10,
    )

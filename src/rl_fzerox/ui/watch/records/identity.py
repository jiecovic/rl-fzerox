# src/rl_fzerox/ui/watch/records/identity.py
"""Track-record identity and difficulty lookup rules.

Record keys need to distinguish ordinary courses, GP difficulties, and
generated X-Cup courses while still supporting older Watch snapshot keys.
"""

...
from rl_fzerox.core.runtime_info import bool_info, float_info, int_info, optional_int_info, str_info
    ...
    player = PlayerTelemetry(
        {
            ...
            "recoil_tilt_magnitude": _mapping_float(
                player_value,
            ...
            "ko_star_count": _mapping_int(player_value, "ko_star_count"),
            "segment_index": _mapping_optional_int(player_value, "segment_index"),
            "segment_t": _mapping_float(player_value, "segment_t"),
            "segment_length_proportion": _mapping_float(
                player_value,
                "segment_length_proportion",
            ),
            "world_pos_x": _mapping_float(player_value, "world_pos_x"),
            "world_pos_y": _mapping_float(player_value, "world_pos_y"),
            "world_pos_z": _mapping_float(player_value, "world_pos_z"),
            "segment_center_x": _mapping_float(player_value, "segment_center_x"),
            "segment_center_y": _mapping_float(player_value, "segment_center_y"),
            "segment_center_z": _mapping_float(player_value, "segment_center_z"),
            "local_lateral_velocity": _mapping_float(
                player_value,
                "local_lateral_velocity",
            ),
            "signed_lateral_offset": _mapping_float(
                player_value,
            ...
            "future_local_nearest_segment_index": _mapping_optional_int(
                player_value,
                "future_local_nearest_segment_index",
            ),
            "future_local_nearest_segment_distance": _mapping_float(
                player_value,
                "future_local_nearest_segment_distance",
            ),
            "velocity_magnitude": _mapping_float(player_value, "velocity_magnitude"),
            "acceleration_magnitude": _mapping_float(
                player_value,
            ...
            "machine_character_index": _mapping_int(
                player_value,
    ...
    return FZeroXTelemetry(
        {
            ...
            "in_race_mode": bool_info(data, "in_race_mode", numeric=True),

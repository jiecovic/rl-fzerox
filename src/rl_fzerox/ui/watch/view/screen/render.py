    ...
    *,
    ...
    return _draw_frame(
        ...
        data=FrameRenderData(
            ...
            best_finish_rank_times=snapshot.best_finish_rank_times,
            best_finish_rank_setups=snapshot.best_finish_rank_setups,
            best_finish_times=snapshot.best_finish_times,
            best_finish_time_ranks=snapshot.best_finish_time_ranks,

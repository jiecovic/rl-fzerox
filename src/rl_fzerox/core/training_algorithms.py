...
LEGACY_PPO_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_AUTO,
        TRAIN_ALGORITHM_PPO,
    }
)
MASKABLE_TRAINING_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_AUTO,
...
RECURRENT_TRAINING_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_MASKABLE_RECURRENT_PPO,
...
SB3X_TRAINING_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_MASKABLE_RECURRENT_PPO,
...
FULL_MODEL_POLICY_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_MASKABLE_RECURRENT_PPO,
        TRAIN_ALGORITHM_HYBRID_ACTION_PPO,
        TRAIN_ALGORITHM_HYBRID_RECURRENT_PPO,
...
SAVED_POLICY_ALGORITHMS: Final[frozenset[TrainAlgorithmName]] = frozenset(
    {
        TRAIN_ALGORITHM_MASKABLE_RECURRENT_PPO,
        TRAIN_ALGORITHM_HYBRID_ACTION_PPO,
        TRAIN_ALGORITHM_HYBRID_RECURRENT_PPO,

...
def _candidate_from_mapping(raw: object) -> EngineTuningCandidateState | None:
    ...
    raw_episode_count = _mapping_int(raw, "episode_count")
    episode_count = None if raw_episode_count is None else max(0, raw_episode_count)
    return_count = _mapping_int(raw, "return_count")
    ...
    completion_score_total = _mapping_float(raw, "completion_score_total")
